<div class="col">
    <div class="card m-4 rounded-3">
        <div class="card-header py-3">
            <h4 class="my-0 fw-normal text-center">Quel sondage voulez-vous créer ?</h4>
        </div>
        <div class="card-body">
            <form id="questionnaireForm">
                <div class="step" id="step1">
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label w-100" for="sendvalue-v1">Expérience utilisateur (UX)
                            </label>
                            <label class="small mb-3"><i>Évaluer l’ergonomie et l’expérience générale des utilisateurs sur votre site.</i></label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="typetunnel" value="contenu" id="sendvalue-v2">
                            <label class="form-check-label w-100" for="sendvalue-v2">Contenu du site
                            </label>
                            <label class="small mb-3"><i>Mesurer la satisfaction par rapport au contenu proposé.</i></label>
                        </div>
                        <div class="form-check">
                            ...
                            <label class="small mb-3"><i>Obtenir une vision globale sur l’impression générale.</i></label>
                        </div>
                        <div class="form-check">
                            ...
                            Concevez votre sondage personnalisé
                            </label>
                            <label class="small mb-3"><i>Configurez un sondage unique.</i></label>
                        </div>
                    </div>
                ...
                <div class="step d-none" id="step2">
                    <div class="mb-3">
                    <div class="form-check">
                            <input class="form-check-input" type="radio" name="design" value="popup" id="sendvalue-v5" checked>
                    ...
                    <div class="text-center">
                        <button class="btn btn-primary float-end sendBtn" type="submit" id="envoyer_reponses">Créez mon sondage</button>
                    </div>
                </div>

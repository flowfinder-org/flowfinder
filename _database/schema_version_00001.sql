...
CREATE TABLE IF NOT EXISTS `collections` (
  ...
  INDEX `IDX_TRACEUR_UUID` (`traceur_uuid` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 0
...
CREATE TABLE IF NOT EXISTS `visiteur_sessions` (
  ...
  INDEX `IDX_VISITEUR_SESSION_UUID` (`visiteur_session_uuid` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 0
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `visiteurs` (
  ...
  UNIQUE INDEX `IDX_VISITEUR_UUID` (`visiteur_uuid` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 0
DEFAULT CHARACTER SET = utf8mb4;
